    ...
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          What began as a small utility to check coin prices grew into a comprehensive crypto tracking platform. &apos;With real-time data, historical analysis, and interactive tools, Here &apos;this project now offers everything a crypto enthusiast or investor needs to stay informed and in control.
        </p>
      </div>
